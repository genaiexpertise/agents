...
class MeetingPreparationTasks():
	def research_task(self, agent, participants, context):
		return Task(
			...
			agent=agent,
			output_file = 'assets/research_report.md'
		)
	...
	def industry_analysis_task(self, agent, participants, context):
		return Task(
			...
			async_execution=True,
			agent=agent,
			output_file='assets/industry_analysis_report.md'
		)
	...
	def meeting_strategy_task(self, agent, context, objective):
		return Task(
			...
			agent=agent,
			output_file ='assets/meeting_strategy_report.md'
		)
	...
	def summary_and_briefing_task(self, agent, context, objective):
		return Task(
			...
			agent=agent,
			output_file='assets/summary_and_briefing_report.md'
		)